# ✈️ AKULAS v1.0.0 | SuperSim Pro Hub
...
### 🌟 Ciri-Ciri Utama:
* **Sticky Results**: Harga SuperSim sentiasa "lock" di atas skrin.
* **Tap-to-Copy**: Cukup sekadar tekan pada kotak harga untuk menyalin nilai terus ke dalam clipboard.
* **Smart Input Focus**: Kotak input akan dikosongkan secara automatik apabila disentuh.
* **Live Fleet Logic**: Masukkan jumlah seat asal dari game, dan sistem akan mengira kapasiti sebenar (Seats x 2 * Freq) secara automatik.
* **Reset Button**: Bersihkan semua data dengan satu klik.
...
3. **Fleet List**: 
   ...
   * Masukkan jumlah seat asal dari game.
   * Masukkan jumlah kekerapan penerbangan (Frequency).
4. **Copy**: Klik pada kotak harga yang terhasil di bahagian atas skrin.
