...
function addAircraft() {
    ...
    // Memasukkan label ke dalam container supaya boleh scroll sekali dengan input
    ...
    row.innerHTML = `
        <input type="text" placeholder="A388" oninput="saveData()" onfocus="this.select()">
    ...
    // Autosave panggil fungsi dari supersim.js
...
window.onload = () => { 
    // loadData() didefinisikan dalam supersim.js
    if (typeof loadData === "function") {
        loadData(); 
    }
    if(aircraftCount === 0) addAircraft(); 
};
